...
const cacheName = 'LAWK5AllieLibeer-2021-03-03 16:37:22.735490'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'LAWK5AllieLibeer'.length) === 'LAWK5AllieLibeer') {
